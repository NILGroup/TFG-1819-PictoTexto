...
\item Se establece el determinante del sujeto utilizando la función \textbf{setDeterminer} de SimpleNLG, sobre el objeto creado anteriormente. En caso de que la lista de palabras que forman el sujeto, no contenga un pronombre o un determinante, se añade el determinante por defecto ``el''. En caso contrario se añadirá el determinante o pronombre, en lugar del determinante de por defecto.
