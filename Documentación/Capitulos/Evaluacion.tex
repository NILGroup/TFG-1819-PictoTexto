...
Una vez analizados los datos obtenidos de la evaluación y encontrados algunos de los fallos y su posible solución en un futuro, que han mostrado estos resultados. No hay que olvidar que no se ha encontrado nada que haga para lo que se pensó esta aplicación, realizar una traducción de pictograma a lenguaje natural. Por todo ello no encontramos ante unos resultados bastante alentadores que demuestran que se ha creado una aplicación con una buena base sobre la que seguir desarrollando para en un futuro completarla y mejorarla. 
