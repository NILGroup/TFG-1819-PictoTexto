...
Como podemos observar en la tabla de resultados, el corpus formado por frases sencillas y un mayor número de pictogramas en la traducción de cada frase (corpus de conciencia léxica modelos de frases) presenta un porcentaje de acierto del 70\%, los corpus que también cuentan con frases sencillas pero son más restrictivos en los pictogramas a traducir (corpus de fotos-pictogramas y corpus de frases absurdas) el porcentaje de acierto es de un 41\% y un 53\% respectivamente, mientras que el otro corpus, al estar compuesto por frases con un nivel mayor de complejidad, el porcentaje de acierto es más bajo, un 20\%.
...
\hline \hline
Fallo complementos un pictograma & 49/139 & 35,25\% \\ \hline
Frases reflexivas & 18/139 & 12,95\% \\ \hline
Más de un verbo en la oración & 3/139 & 2,16\% \\ \hline
Más de un sustantivo en el sujeto & 2/139 & 1,4\% \\ \hline
Pictogramas tachados & 12/139 & 8,6\% \\ \hline
Errores analizador del lenguaje & 12/139 & 8,6\% \\ \hline
Relación determinante y sustantivo & 32/139 & 23\% \\ \hline
Relación preposición y determinante & 11/139 & 7,9\% \\ \hline
Total de Fallos & 139/139 & 100\% \\ \hline 
\end{tabular}
