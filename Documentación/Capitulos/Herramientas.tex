...
\section{Angular CLI}
%-------------------------------------------------------------
\label{cap3:sec:Angular CLI}
Angular CLI es un framework de desarrollo creado y desarrollado por Google, cuya finalidad consiste en el desarrollo de aplicaciones web SPA (Single-Page Applications), es decir, interacción web con una sola página web. Esta herramienta nos aporta tanto una mayor flexibilidad, como una mayor operabilidad en la parte del cliente del servidor, haciendo que dicha parte sea más rápida, dinámica y fluida.
