...
Para nuestro proyecto la función principal que realizará spaCy será la de analizador de los pictogramas que conforman la oración a traducir, dando como resultado un objeto con todas las características de cada palabra. Dicho objeto será utilizado posteriormente por nuestro generador del lenguaje (Simple-NLG) para reproducir el texto resultante.
...
Además Angular está formado por diferentes módulos diferentes unos de otros y cada módulo a su vez por diferentes componentes, permitiendo una mayor personalización e independencia en framework.
