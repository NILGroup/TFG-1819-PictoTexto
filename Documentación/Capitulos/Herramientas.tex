...
Para esta función de análisis se eligió usar la librería Spacy por delante de otras como NLTK o CORENLP, esta elección se basó principalmente en que de estas tres herramientas Spacy, sobre todo en lo referente a la precisión o exactitud cuando realiza un análisis de las palabras, como podemos observar en la figura \ref{fig:precisionSpacy} .\\

\figura{Bitmap/Herramientas/precisionSpacy}{width=200px}{fig:precisionSpacy}{Comparación de la precisión entre Spacy, NLTK, CORENLP.}
