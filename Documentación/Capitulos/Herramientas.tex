...
Para conseguir la traducción de cada pictograma hemos utilizado la propia API de Arasaac, centrándonos principalmente en la parte de obtención de pictogramas, como podemos observar en la  Figura \ref{fig:principal}\figura{Bitmap/Herramientas/PrincipalAPI}{width=300px}{fig:principal}{Presentación de la API de Arasaac}.
