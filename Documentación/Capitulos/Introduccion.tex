...
Para intentar asegurar la correcta resolución del proyecto se realizaran entregas constantes tanto de memoria como de código. Dos o tres veces al mes la memoria y una versión funcional de la aplicación serán revisadas por nuestras tutoras, comprobando así vamos o no por el buen camino.
