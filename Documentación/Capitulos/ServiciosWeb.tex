...
%------------------------------------------------------------------
\section{Servicio de Generación de análisis de palabras}
%-------------------------------------------------------------------
\label{cap5:sec:ServicioAnalisis}

Servicio de análisis de palabras (/translate/getWordAttrs?word='PalabraAClasificar'): este servicio web recibe a través de una petición GET una palabra tal y como podemos ver en la Figura \ref{fig:attrsRequest}.
